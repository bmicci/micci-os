...
const IMMEDIATE_ROLL = 110630

// Waterfall stages
const waterfallData = [
  { label: 'HELOC Limit (Confirmed)', amount: 190000, color: '#22c55e' },
  { label: '→ Immediate Roll (high-rate debt)', amount: -110630, color: '#ef4444' },
  { label: '= Available After Roll', amount: 79370, color: '#3b82f6' },
  { label: '→ Promo payoffs (as they expire)', amount: -51118, color: '#f59e0b' },
  { label: '= Final Available Buffer', amount: 28252, color: '#22c55e' },
]
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <KPICard label="HELOC Limit (Confirmed)" value="$190,000" note="Loan Depot · 6.85% variable" accent="green" />
        <KPICard label="Immediate Roll at Close" value="$110,630" note="High-rate accounts" />
        <KPICard label="HELOC After Roll" value="$79,370" note="Available for promo payoffs" />
        <KPICard label="Monthly HELOC Interest" value="$777" note="Interest-only on $110,630 at 6.85%" accent="red" />
