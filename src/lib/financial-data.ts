...
export const DEBTS: DebtAccount[] = [
  { name: 'SoFi Personal Loan', balance: 56958.92, rate: 12.41, min: 1464.07, decision: 'roll', category: 'Personal Loan' },
  { name: 'LightStream Loan', balance: 44018.42, rate: 5.87, min: 577.47, decision: 'keep', category: 'Personal Loan' },
  { name: 'Chase Freedom Unlimited (7117)', balance: 22531, rate: 0, min: 225, decision: 'promo', category: 'Credit Card' },
  { name: 'Chase Freedom (9313)', balance: 13269, rate: 0, min: 132, decision: 'promo', category: 'Credit Card' },
  { name: 'Citi Diamond Preferred', balance: 12366, rate: 0, min: 124, decision: 'promo', category: 'Credit Card' },
  ...
  { name: 'AmEx Platinum — Old Plan It®', balance: 2252.41, rate: 15.5, min: 230.97, decision: 'roll', category: 'Credit Card' },
  { name: 'AmEx Platinum — New Plan It®', balance: 2835.58, rate: 15.5, min: 270.12, decision: 'roll', category: 'Credit Card' },
  { name: 'AmEx Platinum — Revolving', balance: 513.11, rate: 27.49, min: null, decision: 'roll', category: 'Credit Card' },
  { name: 'AmEx Gold — Plan It®', balance: 1776.88, rate: 15.5, min: 182.18, decision: 'roll', category: 'Credit Card' },
  { name: 'AmEx Personal Loan', balance: 3942.57, rate: 7.33, min: 407.01, decision: 'keep', category: 'Personal Loan' },
  { name: 'Nordstrom (Synchrony)', balance: 653.43, rate: 29.4, min: 40, decision: 'roll', category: 'Credit Card' },
  { name: 'Citi Best Buy 4802', balance: 2230.40, rate: 0, min: 50, decision: 'promo', category: 'Credit Card' },
  { name: 'Chase Prime Visa', balance: 627.73, rate: 0, min: 95.77, decision: 'promo', category: 'Credit Card' },
  { name: 'PayPal Credit', balance: 124.35, rate: 0, min: 30, decision: 'promo', category: 'Credit Card' },
  { name: 'BofA Mortgage', balance: 498903.37, rate: 3.375, min: 2486.79, decision: 'keep', category: 'Mortgage' },
]
...
export const MODULES: FinancialModule[] = [
  ...
  },
  {
    ...
    actions: ['Confirm HELOC closing date with Loan Depot', 'Verify Chase Freedom cards are 100% at 0%', 'Get Virginia FCU + Wells Fargo current balance statements'],
  },
  {
...
export const ACTION_ITEMS: ActionItem[] = [
  { priority: 'red', title: 'HELOC closing — confirm Loan Depot timeline', detail: 'Must close before March 19. VVOE required. Do NOT resign before closing.' },
...
export const BURN_RATE: BurnRateItem[] = [
  ...
  { label: 'AmEx Personal Loan', current: 407.01, survival: 0, note: '7.33% > 6.85% — ROLLS into HELOC' },
...
export const HELOC_ACCOUNTS: HELOCAccount[] = [
  { name: 'SoFi Personal Loan', balance: 56958.92, rate: 12.41, moNow: 589.05, decision: 'roll' },
  ...
  { name: 'AmEx Platinum Revolving', balance: 513.11, rate: 27.49, moNow: 11.76, decision: 'roll' },
  { name: 'AmEx Platinum Old Plan It®', balance: 2252.41, rate: 15.5, moNow: 29.09, decision: 'roll' },
  { name: 'AmEx Platinum New Plan It®', balance: 2835.58, rate: 15.5, moNow: 36.59, decision: 'roll' },
  { name: 'AmEx Gold Plan It®', balance: 1776.88, rate: 15.5, moNow: 22.95, decision: 'roll' },
  ...
  { name: 'AmEx Personal Loan', balance: 3942.57, rate: 7.33, moNow: 407.01, decision: 'keep' },
  { name: 'Chase BT balances (0% promo)', balance: 35925.48, rate: 0, moNow: 0, decision: 'promo' },
  { name: 'Citi Diamond (0% thru Jun 27)', balance: 12366, rate: 0, moNow: 0, decision: 'promo' },
  { name: 'Citi Best Buy promos', balance: 2230.40, rate: 0, moNow: 0, decision: 'promo' },
